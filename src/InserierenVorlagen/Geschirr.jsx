...
function Geschirr() {
  const [data, setData] = useState({
    ...
    "Aussehen/Farbe": '',
    "Material": '',
    "Umfang": '', // Nur wenn es ein Set ist
    "Zustand": '',
  });
  ...
  const handleCopyAll = () => {
    ...
    text += "Werbetext und Beschreibung\n\nAuf Wunsch kann der Artikel per Fragile verschickt werden. Dafür verrechnen wir zusätzlich CHF 7.50. Ansonsten übernehmen wir keine Haftung für Transportschäden. \n\nProjekt Restwert Schönbühl\nÖffnungszeiten: Montag - Freitag 08:00 - 12:00 Uhr und 13:00 - 16:30 Uhr";
